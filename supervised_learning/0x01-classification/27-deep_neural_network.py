...
class DeepNeuralNetwork:
    ...
    Instance method: def save(self, filename)
    Static method: def load(filename)
    """
    ...
    def save(self, filename):
        """
        Instance method that saves the instance object
    ...
    def load(filename):
        """
        Instance method that loads a pickled DeepNeuralNetwork object
        Args:
